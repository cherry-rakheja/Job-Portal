...
const Jobseeker = () => {
    ...
    const filteredjobs = job.filter((elem) => {
        ...
        const locationMatch =
            elem.location.toLowerCase().includes(location.toLowerCase())
    ...
    return (
        <div className="min-h-screen bg-[#060D17] text-white">
            ...
            <main className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
                ...
                {/* Search */}
                <div className="mb-8 flex flex-col gap-3 rounded-xl border border-white/10 bg-[#0B111D] p-3 md:flex-row">
                    ...
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full rounded-lg border border-white/10 bg-[#060D17] py-3 pl-11 pr-4 text-sm outline-none placeholder:text-white/30 focus:border-[#492DBB]"
                        />
                    ...
                    <div className="relative flex-1">
                        ...
                        <i className="ri-map-pin-line absolute left-4 top-1/2 -translate-y-1/2 text-white/40"></i>
                ...
                <div className="space-y-4">
                    ...
                    {filteredjobs.map((elem) => (
                        ...
                        <div
                            key={elem._id}
                            className="rounded-xl border border-white/10 bg-[#0B111D] p-5 transition hover:border-[#492DBB]/60"
                        >

                            <div className="flex gap-4">

                                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-[#492DBB]/20">
                            ...
                            <div className="mt-4 flex flex-wrap gap-2">
                                ...
                                {elem.skills.map((skill, index) => (
                                    ...
                                    <span
                                        key={index}
                                        className="rounded-md bg-[#060D17] px-3 py-1 text-xs text-white/60"
                                    >
                                        {skill}
                                    </span>
                            ...
                            <div className="mt-5 flex flex-col gap-3 border-t border-white/10 pt-4 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <button onClick={()=>{
                                 ...
                                 className="rounded-lg bg-[#492DBB] px-5 py-2 text-sm font-semibold hover:bg-[#5a3bd0]">
                                    View Job
                                </button>
